...
\end{verbatim}
    ...
    \subsection{Keyboard shortcuts}
        ...
        same time as you press a shortcut key. Instead of
...
\section{More on text editing}
    ...
    \subsection{Cut, copy and uncut}
        ...
        copy or cut multiple lines one at a time. The clipboard holds a maximum of 3 kB of data.

        Uncut (Ctrl+U) copies the content of the clipboard into the text buffer at the cursor position. It is possible
        to do repeated uncuts. The clipboard is cßleared upon the first cut or copy after uncutting.
