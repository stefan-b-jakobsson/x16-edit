...
\section{Features}
    ...
    \label{wordwrap}
        ...
        The word wrap function is what I'm least satisfied with. I might come back and reimplement it from the ground in the future.
...
\section{File handling}
    ...
    be typed in at the prompt that is displayed. File names may 
    be just the name of the file or complete CBM DOS paths.

    If you are in ISO mode, it's recommended to type file names in upper case. Otherwise file names will
    probably not make sense when you list the directory in one of the PETSCII modes.


    \subsection{File browser}

    At the prompt where a file name is typed in you may press Ctrl+T to show the
